    ...
    <div className=' w-full '>
      ...
      <div className=' r-w py-6 md:py-12 md:flex md:items-center md:gap-10 mb-4'>
        <div className='mb-4 md:mb-0 md:w-2/3 text-center md:text-left'>
          ...
          <Image priority width={400} height={100} src={ImagePath.LOGO} alt='banner img' className='h-auto !mb-4 m-auto md:mx-0 w-[180px] md:w-[240px] ' />
        ...
        <div className='md:mb-0 hidden md:block'>
          <Image priority width={400} height={200} src={ImagePath.MAIN_BANNER} alt='banner img 2' className=' h-auto m-auto md:mx-0 w-2/3 md:w-full' />
        </div>
      </div>
      ...
      <div className='py-6 md:flex md:items-center md:gap-5 r-w'>
        <Image priority src={'/girl_img_opt_c.webp'} width={280} height={300} className=' max-w-full h-auto mb-4 md:mb-0 m-auto md:mx-0' alt='girl image' />
