    ...
    <div className="w-full">
      ...
      <div className="r-w md:flex md:items-center md:gap-12 py-6 md:py-16 text-center md:text-left">
        <div className="md:w-2/3 mb-4 md:mb-0 ">
          <h2 className="g-t mb-4 font-extrabold text-3xl md:text-7xl bg-gradient-to-r from-[#001FCF] to-[#007EFF] inline-block text-transparent bg-clip-text">
            About Care+
          </h2>
          <p className="mb-2 text-lg font-medium text-gray-800 md:text-justify">
            Every Child is Special and Deserves an Education as per Their Own Needs
          </p>
